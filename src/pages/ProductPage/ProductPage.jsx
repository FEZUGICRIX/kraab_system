          ...
          <div className="product-info__container">
            ...
            <div className="product-info__content content">
              ...
              <div className="content__buttons">
                <select name="size" id="size" className="content__size">
                  <option disabled selected aria-placeholder="true">
                    Select Size
                  </option>
                ...
                <button className="bag-btn black-btn">
                  Add to shopping bag
                </button>
              </div>
            </div>
      ...
      <section className="like">
        <div className="container">
          <div className="like__container">
            <div className="like__title">You may also like it:</div>
